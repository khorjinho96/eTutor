       ...
       <form method="post" id="add_blog_form" onsubmit="return false;" >
                        <div class="form-group">
                            ...
                            <small id="BlogTitleInputHelp" class="form-text  " style="color: red"><?php
                                if(isset($_SESSION['EditBlogTitleErr'])){
                                    echo $_SESSION['EditBlogTitleErr'];
                                    unset($_SESSION['EditBlogTitleErr']);
                                }
                                ?></small>
                        </div>
                        <div class="form-group">
                            ...
                            <small id="BlogTitleInputHelp" class="form-text  " style="color: red"><?php
                                if(isset($_SESSION['EditBlogCategoryErr'])){
                                    echo $_SESSION['EditBlogCategoryErr'];
                                    unset($_SESSION['EditBlogCategoryErr']);
                                }
                                ?></small>
                        ...
                        <div class="form-group">
                            ...
                            <small id="BlogDescriptionInputHelp" class="form-text  " style="color: red"><?php
                                if(isset($_SESSION['EditBlogDescriptionErr'])){
                                    echo $_SESSION['EditBlogDescriptionErr'];
                                    unset($_SESSION['EditBlogDescriptionErr']);
                                }
                                ?></small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <small id="BlogContentInputHelp" class="form-text  " style="color: red"><?php
                                if(isset($_SESSION['EditBlogContentErr'])){
                                    echo $_SESSION['EditBlogContentErr'];
                                    unset($_SESSION['EditBlogContentErr']);
                                }
                                ?></small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <small id="ImagesUploadHelp" class="form-text  " style="color: red"><?php
                                if(isset($_SESSION['EditImagesUploadErr'])){
                                    echo $_SESSION['EditImagesUploadErr'];
                                    unset($_SESSION['EditImagesUploadErr']);
                                }
                                ?></small>
                        </div>
