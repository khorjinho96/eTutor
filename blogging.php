        ...
        <div class="col-md-12 col-xs-12 col-sm-12">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    if(preg_match("/^\W+$/", $_REQUEST['search_input'])||empty(trim($_REQUEST['search_input'])) ) {
                        echo '<p >Content not found!</p>';

                    }else{
                        $search_input= filter_var( $_REQUEST['search_input'], FILTER_SANITIZE_STRING);
                        ...
                        $category_input= filter_var($_REQUEST['category_input'], FILTER_SANITIZE_STRING) ;
                        $total_pages_sql = "SELECT COUNT(*) FROM blog WHERE                       
